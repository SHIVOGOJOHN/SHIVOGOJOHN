...
img_contact_form = Image.open("images-18.jpeg")
img_contact_form1 = Image.open("images-17.jpeg")
...
def handle_payment():
    payment = paypalrestsdk.Payment({
        ...
        "redirect_urls": {
            "return_url": "https://your-app-name.herokuapp.com/payment/execute",
            "cancel_url": "https://your-app-name.herokuapp.com/payment/cancel"
        },
        "transactions": [{
            "amount": {
                "total": "100.00",
    ...
    if payment.create():
        ...
        st.markdown(f'[Pay Now]({approval_url})')
    else:
        st.error("Error while creating PayPal payment")
